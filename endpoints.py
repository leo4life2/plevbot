endpoints = {
    ...
    'poll_data': 'https://pollev.com/proxy/api/participant/free_text_polls/{uid}?include=collection',
    'respond_to_poll': 'https://pollev.com/proxy/api/participant/free_text_polls/{uid}/results',
